...
const newsArticles = [
    {
        ...
        id: "2026-02-25-patch1.0.0-release-date", 
        // Article title that appears in the header
        title: "Pokémon Null - Release Date Announced",
        // Publication date in YYYY-MM-DD format
        date: "2026-02-25",
        // Short summary that appears in previews and collapsed view
        summary: "Pokémon Null, the evolution of Nuzlockes, is launching on March 2nd! Get ready for a new level of challenge.",
        // Full article content - can include HTML tags for formatting
        content: `
            <h4>Release Details:</h4>
            <ul>
                <li><strong>Pokémon Null will launch on March 2nd, 2026, following the very special Launch Event!</strong></li>
